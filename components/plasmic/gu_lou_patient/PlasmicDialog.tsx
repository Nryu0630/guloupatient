...
import Button from "../../Button"; // plasmic-import: M85d5PuEYHjB/component
...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: Sw7YkqK-THBr/css

import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: UOj21FVOkWIl/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: e3mjAV2QY1_m/icon
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__iNiEh)}
              >
                <div
                  className={classNames(
                    projectcss.all,
